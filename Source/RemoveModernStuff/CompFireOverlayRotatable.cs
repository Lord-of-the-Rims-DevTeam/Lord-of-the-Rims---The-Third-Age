...
namespace RimWorld {
    ...
    public class CompFireOverlayRotatable : ThingComp {
        ...
        private GraphicRotatable FireGraphic = null;

        public CompProperties_FireOverlay_Rotatable Props =>
            (CompProperties_FireOverlay_Rotatable) this.props;
        ...
        public void LoadGraphics() {
            try {
                ...
                UnityEngine.Debug.Log($"TTA: CompFireOverlay caught an exception {e}.");
            }
        }
            ...
            try {
                ...
                switch (thing.Rotation.AsInt) {
                    ...
                    case 3: // east
                        ...
                        break;
                    default:
                        throw new Exception($"TTA: CompFireOverlay found thing {thing} with invalid rotation.");
                }
                ...
                UnityEngine.Debug.Log($"TTA: CompFireOverlay caught exception {e}.");
            }
        }
        ...
        private void FireFlicker(Vector3 drawPosRotated, Vector3 drawSizeRotated, Quaternion quaternion) {
            ...
            Vector3 radial = GenRadial.RadialPattern[_scramble %
                GenRadial.RadialPattern.Length].ToVector3() / GenRadial.MaxRadialPatternRadius;
            radial *= 0.05f;
